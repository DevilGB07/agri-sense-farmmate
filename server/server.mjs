...
const OPENWEATHER_API_KEY = 'd399592a95087d57390b43b420d7636f';
const FALLBACK_CITY = "Nashik,IN";

async function getWeatherData(lat, lon, season) {
    const fallbackWeather = { ...seasonalData[season].weather, city: FALLBACK_CITY };
    if (OPENWEATHER_API_KEY === 'YOUR_API_KEY_HERE') {
        console.log("Using fallback weather data. Please replace 'YOUR_API_KEY_HERE' in server/server.mjs with your OpenWeatherMap API key.");
