  ...
  return (
    <div className="p-4 space-y-6 bg-gradient-earth min-h-screen">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-bold text-foreground">{t('farmDashboard')}</h2>
      ...
      <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <StaggerItem>
          <DashboardCard title={t('weatherAQI')} icon={<Cloud className="h-6 w-6 text-primary" />}>
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="text-muted-foreground">{t('rainfall')}</p>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="text-muted-foreground">{t('aqi')}</p>
        ...
        <StaggerItem>
          <DashboardCard title={t('soilHealth')} icon={<Eye className="h-6 w-6 text-accent" />}>
            <div className="space-y-4">
              <div>
                <div className="flex justify-between text-sm mb-2">
                  <span>{t('moistureLevel')}</span>
        ...
        <StaggerItem className="md:col-span-2">
          <DashboardCard title={t('aiCropRec')} icon={<Sprout className="h-6 w-6 text-success" />}>
            <div className="space-y-3">
              ...
              <Button variant="outline" className="w-full" onClick={() => setShowAllCrops(!showAllCrops)}>
                {showAllCrops ? t('viewLess') : t('viewAllRec')}
              </Button>
            </div>
          </DashboardCard>
        </StaggerItem>
